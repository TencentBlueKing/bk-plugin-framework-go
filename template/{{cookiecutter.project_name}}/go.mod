...
require (
	...
	github.com/TencentBlueKing/bk-apigateway-sdks v0.1.16 // indirect
...
replace github.com/RichardKnop/machinery/v2 v2.0.11 => github.com/hanshuaikang/machinery/v2 v2.0.14
